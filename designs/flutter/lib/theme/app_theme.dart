...
class AppSemanticColors extends ThemeExtension<AppSemanticColors> {
  ...
  AppSemanticColors lerp(ThemeExtension<AppSemanticColors>? other, double t) {
    ...
    return this; // discrete swap is fine — we don't animate theme changes
  }
}

/// Tiny app-wide toggle so SettingsScreen can flip the theme without
/// plumbing a callback through every route. Listen to it with
/// ValueListenableBuilder in main.dart (see lib/main.dart).
    ...
    return ThemeData(
      ...
      switchTheme: SwitchThemeData(
        ...
        trackColor: WidgetStateProperty.resolveWith(
          (states) => states.contains(WidgetState.selected) ? c.cobalt : c.mistStrong,
        ),
      ),
    );
  }
